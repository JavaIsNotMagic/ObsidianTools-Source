...
import com.haxium.basicmod.obsidian.armor.blocks.*;
import com.haxium.basicmod.obsidian.armor.handlers.*;
import com.haxium.basicmod.obsidian.armor.items.*;
import com.haxium.basicmod.obsidian.armor.tabs.*;
...
public class ObsidianArmor {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ItemObsidianGeneric obsdidian_dust = new ItemObsidianGeneric("obsdian_dust");
		GameRegistry.registerItem(obsdidian_dust, "ObsidianDust");
	...
	public void init(FMLInitializationEvent event) {
		...
		GameRegistry.addSmelting(ObsidianArmor.obsidian_dust, new ItemStack(ObsidianArmor.obsidian_ingot, 2), 5F);
	}
}
